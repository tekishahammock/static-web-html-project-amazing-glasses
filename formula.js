...
var divRed = document.getElementById("red-dragon");
var divBlue = document.getElementById("blue-dragon-dragon");
var divGreen = document.getElementById("green-dragon");
var divWhite = document.getElementById("white-dragon");
var divBlack = document.getElementById("black-dragon");
var divPink = document.getElementById("pink-dragon");
var divPurple = document.getElementById("purple-dragon");
var divOrange = document.getElementById("orange-dragon");

var loopCount = dragon-eggs.length

for (var loopTracker = 0; loopTracker < loopCount; loopTracker += 1) {

	divRed.innerHTML = "<div>" + dragon-eggs[loopTracker] + "</div>";
}
 ...
 // +// THE ARRAY
 // +
 // +var dragon-eggs = [ red-dragon, blue-dragon, green-dragon, white-dragon, black-dragon, pink-dragon, purple-dragon, orange-dragon ]
 // +
